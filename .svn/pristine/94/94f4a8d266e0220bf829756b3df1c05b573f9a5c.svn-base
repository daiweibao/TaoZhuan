...
#import "SpendMoneyDetailController.h"
#import "GetMoneyListCell.h"
#import "TotalGetMoneyModel.h"

@interface SpendMoneyDetailController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SpendMoneyDetailController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.backButton.hidden = NO;
    self.titleLabel.text = @"花费明细";
...
-(void)loadData{
    ...
    [GXJAFNetworking POST:getUserCostRecord parameters:dict success:^(id  _Nullable responseObject) {
