...
//展示动画
+ (void)showLuckyDrawSuccessAnimation{
    //设置坐标
    UIView *backgroundView = [[UIView alloc] initWithFrame:[UIApplication sharedApplication].keyWindow.bounds];
    backgroundView.userInteractionEnabled = NO;//关闭交互
    [[UIApplication sharedApplication].keyWindow addSubview:backgroundView];

    //开始粒子效果
    CAEmitterLayer *emitterLayer = addEmitterLayer(backgroundView,backgroundView);
